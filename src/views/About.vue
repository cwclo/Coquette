<template>
  <div
    class="min-h-screen flex items-center justify-center text-center px-4 py-20 bg-center bg-no-repeat bg-contain bg-gray-300"
    style="background-image: url('/images/logos/coquette_logo_beige_cmyk.png')"
  >
    <div class="bg-white/60 backdrop-blur-sm rounded-lg p-8">
